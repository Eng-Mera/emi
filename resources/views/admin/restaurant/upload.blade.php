...
@section('main-content')
    ...
    <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="{{ url('/admin/importBranches') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
        <input type="file" name="import_branch" />
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <button class="btn btn-primary">Import Branches</button>
    </form>
@stop