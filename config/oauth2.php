...
return [
    ...
    'grant_types' => [
        'password' => [
            'class' => '\App\Grant\PasswordGrant',
            'access_token_ttl' => 604800,
            'callback' => '\App\User@verifyPassword'
        ],
        'special_code' => [
            'class' => '\App\Grant\PasswordGrant',
            'access_token_ttl' => 604800,
            'callback' => '\App\User@verifyCode'
        ],
        'password_b2b' => [
            'class' => '\App\Grant\PasswordBTwoBGrant',
            'access_token_ttl' => 604800,
            'callback' => '\App\User@verifyPasswordAndRole'
        ],
        'refresh_token' => [
        ...
        'social_media' => [
            'class' => '\App\Grant\SocialMediaGrant',
            'access_token_ttl' => 3600,
            'callback' => '\App\User@verifySocialMedia'
        ], 'social_media_b2b' => [
            'class' => '\App\Grant\SocialMediaGrant',
            'access_token_ttl' => 3600,
            'callback' => '\App\User@verifySocialMediaWithRole'
        ],
        'social_media_update' => [
            'class' => '\App\Grant\SocialMediaUpdateGrant',
            'access_token_ttl' => 604800,
            'callback' => '\App\User@updateSocialId'
        ],
        'social_media_update_b2b' => [
            'class' => '\App\Grant\SocialMediaUpdateGrant',
            'access_token_ttl' => 604800,
            'callback' => '\App\User@updateSocialIdWithRole'
        ]
    ],
    /*
      |--------------------------------------------------------------------------
